...
- Runtime: Docker Compose (non-root контейнер, `cap_drop: ALL`)
...
**Требования:** Python 3.12+, Telegram бот ([@BotFather](https://t.me/BotFather)), форум-супергруппа с Topics, аккаунт MAX.
