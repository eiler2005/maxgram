...
| **L4** мета-мониторинг | жив ли сам наблюдатель | host-мониторинг + встречные пробы + сводка | 5 мин / 24 ч | смерть самого наблюдателя |
...
Ежедневная сводка перечисляет все слои и вешает открытые проблемы на тот слой,
