...
class MaxClientPort(Protocol):
    ...
    def register_disconnect_handler(
        self,
        handler: Callable[[BaseException, bool, float], Awaitable[object]],
    ) -> None: ...
    ...
    async def import_contacts(self, contacts: list[MaxContactImportEntry]) -> list[MaxUserView]: ...
