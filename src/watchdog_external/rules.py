...
#: Направление проверки. Показывает, кто кого спрашивает, — из этого сразу
#: видно, какой конец чинить: L2 инициирует наблюдатель, L3 — сам production.
LAYER_FLOW = {
    "L1": "наблюдатель ──HTTP──► status API bridge",
    "L2": "наблюдатель ──SSH──► production",
