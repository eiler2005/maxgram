...
| `src/adapters/max/adapter.py` (`src/adapters/max_adapter.py`) | MAX facade: operation services over internal backend boundary; старый import path сохранён |
