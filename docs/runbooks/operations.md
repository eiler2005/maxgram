...
- автоматические scans пишут owner/ops только important-only digest: новый/unmapped чат, `needs_invite`, `manual_admin_required`, `account_migration_required` или изменение статусов DM contacts;
