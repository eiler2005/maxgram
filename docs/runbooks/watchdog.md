...
✅ L1 — что болит внутри bridge: отвечает
⚠️ L2 — жив ли контейнер и хост: опрос проходит
      └ Свободное место на production-хосте (disk_low)
⚠️ L3 — не оборвалась ли связь с наблюдателем: молчит 420 с
      └ Push-сигналы с production-хоста (push_stale)
✅ L4 — жив ли сам наблюдатель: цикл проверок работает

Открытых проблем: 2 — они отмечены ⚠️ выше.
```
