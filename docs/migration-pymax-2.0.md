...
Post-migration audit follow-ups folded into canonical docs/runbooks: current
architecture lives in `docs/architecture.md` / ADR-007, test coverage in
`docs/tests.md`, and live validation / rollback in
`docs/runbooks/operations.md`. Этот файл ниже остаётся историческим
implementation spec.
