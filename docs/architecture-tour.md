...
| `BridgeConnectionManager` | `src/adapters/max/backends/pymax/transport.py` | TCP sequence wrap at 256 when PyMax and MAX server diverge | `pymax_tcp_sequence_overflow` marker in MAX adapter tests |
